...
int pins[] = {3, 2, 5, 4, 7, 6, 9, 8, 11, 10, 13, 12,     19, 18, 21, 20, 23, 22, 25, 24, 27, 26, 29,     A14, A15, A12, A13, A10, A11, A8, A9, A6, A7, A4, A5, A2, A3, A0, A1,   46, 47, 44, 45, 42, 43, 40, 41, 38, 39, 36, 37, 34, 35, 32, 33};
int remaining_pins[] = {15, 14, 17, 16,    28, 31, 30}; // unused pins
