...
NoteButton buttons[] = {
    ...
    {3, {note(E, 2), CHANNEL_4}},
    {4, {note(F_, 2), CHANNEL_4}},
    {5, {note(Gb, 2), CHANNEL_4}},
    {6, {note(G, 2), CHANNEL_4}},
    {7, {note(Ab, 2), CHANNEL_4}},
    {8, {note(A, 2), CHANNEL_4}},
    {9, {note(B, 2), CHANNEL_4}},
    {10, {note(C, 3), CHANNEL_2}},
    {11, {note(Db, 3), CHANNEL_2}},
    {12, {note(D, 2), CHANNEL_1}},
/*   // {12, {note(Bb, 2), CHANNEL_2}},
  ...
  //  {A0, {note(B, 3), CHANNEL_2}},  // trzecia taśma 16 tonów
    ...
    {17, {note(C, 2), CHANNEL_2}},
    {16, {note(Db, 2), CHANNEL_2}},
    {19, {note(D, 2), CHANNEL_2}},
    {18, {note(Eb, 2), CHANNEL_2}},
    {21, {note(E, 2), CHANNEL_2}},
    {20, {note(F_, 2), CHANNEL_2}},
    {23, {note(Gb, 2), CHANNEL_2}},
    {22, {note(G, 2), CHANNEL_2}},
    {25, {note(Ab, 2), CHANNEL_2}},
    {24, {note(A, 2), CHANNEL_2}},
    {27, {note(Bb, 2), CHANNEL_2}},
    {26, {note(B, 2), CHANNEL_2}},
    {29, {note(C, 3), CHANNEL_2}},
    {28, {note(Db, 3), CHANNEL_2}},
    {31, {note(D, 3), CHANNEL_2}},
    {30, {note(Eb, 3), CHANNEL_2}},
